...
#knitr::opts_knit$set(root.dir='/Users/marceloqueiroz/Documents/Berkeley/Term2/W203/w203_lab1/Corruption_EDA')
setwd('/Users/marceloqueiroz/Documents/Berkeley/Term2/W203/w203_lab1')
```
...
* Third we dropped columns that will not be useful for our analysis, to 
```{r}
...
We begin the scatter-plot matrix. We want to get a high level overview. The general pattern between pre-2002 and post-2002 are very similar:
```{r}
